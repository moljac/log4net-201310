...
namespace log4net.Layout
{
	...
	public partial class PatternLayout : LayoutSkeleton
	{
		#region Constants
...
#if !NETCF && !SSCLI && !CLIENT_PROFILE && ! __ANDROID__ && ! __XAMARIN_IOS__
			PatternLayoutAspNet();
# elif ! __ANDROID__ && ! __XAMARIN_IOS__
			PatternLayoutAspNet();
...
//#if __ANDROID__ || __XAMARIN_IOS__ || __XAMARIN_MOBILE__  // HolisticWare
			s_globalRulesRegistry.Add("c", typeof(LoggerPatternConverter));
			s_globalRulesRegistry.Add("logger", typeof(LoggerPatternConverter));
